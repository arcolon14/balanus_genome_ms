...
\revpoint{E}{2}\revpoint{1}{1}purifying selection.
\vspace{0.1cm}
...
\comment{stop the sentence her to remove the double "metazoans"} when compared to other metazoans.
...
\comment{Remove the second "background", the largest reduction in diversity was observed in tRNAs, with Pi...}
